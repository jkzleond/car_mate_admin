<table class="table" border="0" cellspacing="1" style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <select name="" id="">
                    <?php $v39803670482iterator = $activity->optionList; $v39803670482incr = 0; $v39803670482loop = new stdClass(); $v39803670482loop->length = count($v39803670482iterator); $v39803670482loop->index = 1; $v39803670482loop->index0 = 1; $v39803670482loop->revindex = $v39803670482loop->length; $v39803670482loop->revindex0 = $v39803670482loop->length - 1; ?><?php foreach ($v39803670482iterator as $option) { ?><?php $v39803670482loop->first = ($v39803670482incr == 0); $v39803670482loop->index = $v39803670482incr + 1; $v39803670482loop->index0 = $v39803670482incr; $v39803670482loop->revindex = $v39803670482loop->length - $v39803670482incr; $v39803670482loop->revindex0 = $v39803670482loop->length - ($v39803670482incr + 1); $v39803670482loop->last = ($v39803670482incr == ($v39803670482loop->length - 1)); ?>
                <option value="<?php echo $activity->depositList[$v39803670482loop->index0]; ?>"> <?php echo $option; ?></option>
                    <?php $v39803670482incr++; } ?>
            </select>
                <?php } ?>
            <?php } ?>
        </td>
