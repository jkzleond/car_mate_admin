                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span3">
                            ...
                            <select name="state" class="input-medium">
                                ...
                                <?php foreach ($exact_state_list as $exact_state) { ?>
                                <option value="<?php echo $exact_state->id; ?>"><?php echo $exact_state->state; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="span3">
                            ...
                            <select name="car_type" class="input-medium">
                                <option value="-1">全部</option>
                                <?php foreach ($car_type_list as $car_type) { ?>
                                <option value="<?php echo $car_type->code; ?>"><?php echo $car_type->name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="span1">
        ...
        $('#insurance_grid').datagrid({
            ...
            columns:[[
                ...
                {field:'id',title:'操作',width:'10%',align:'center', formatter: function(value, row, index){
                    ...
                    var insurance_result_url = "<?php echo $this->url->get('/insuranceResult'); ?>";
                    var insurance_buy_url = "<?php echo $this->url->get('/insuranceBuy'); ?>";
                    var insurance_order_info_url = "<?php echo $this->url->get('/insuranceOrderInfo'); ?>";
