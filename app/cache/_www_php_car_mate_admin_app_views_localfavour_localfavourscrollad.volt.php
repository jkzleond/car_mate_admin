                ...
                <div class="span12">
                    ...
                    <div id="scroll_ad_list">
                        <div id="scroll_ad_use_list" style="fload:left">
                            <?php foreach ($use_list as $scroll_ad) { ?>
                            <div class="drag-item pull-left">
                                <div class="well well-small scroll-pic item" data-id="<?php echo $scroll_ad->id; ?>">
                                    <i class="iconfa-remove tools tools-top tools-unuse"></i>
                                <span class="tools tools-bottom">
                                    <i class="iconfa-edit tools-edit"></i>
                                </span>
                                    <img class="pic" src="data:image/png;base64,<?php echo $scroll_ad->picData; ?>" />
                                    <div class="url" style="position: absolute; bottom: 5px; background-color:#eee; width:240px;"><span><?php echo $scroll_ad->redirectUrl; ?></span></div>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
