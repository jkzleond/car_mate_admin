...
//        {
//            foreach ( $bindParameters as $bindParameter => $bindValue )
//            {
//                if (is_array($bindTypes) and isset($bindTypes[$bindParameter]))
//                {
//                    $bindType = $bindTypes[$bindParameter];
//                    $statement->bindValue($bindParameter, $bindValue, $bindType);
//                }
//                else
//                {
//                    $statement->bindValue($bindParameter, $bindValue);
//                }
//            }
//        }
