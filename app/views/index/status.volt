    ...
    <div id="dashboard-left" class="span8">
        ...
        <ul class="shortcuts">
            <li class="events">
                <a href="">
                    ...
                    <span class="shortcuts-label">{{ date('Y-m-d') }}</span>
                </a>
            </li>
            <li class="archive">
                <a href="">
                    <span class="shortcuts-icon iconsi-archive"></span>
                    <span class="shortcuts-label">违章查询验证码获取： {% if code_status == '200' %}良好{% else %}异常{% endif %} </span>
                </a>
            </li>
            <li class="help">
                <a href="">
                    <span class="shortcuts-icon iconsi-help"></span>
                    <span class="shortcuts-label">首页访问状态： {% if main_status == '200' %}良好{% else %}异常{% endif %} </span>
                </a>
            </li>
        </ul>
        ...
        <div class="widgetcontent nopadding">
            <table width="100%" style="text-align:center;;font-size:14px;line-height:30px;" border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" >{{ interaction.province_name }}</td>
                    <td bgcolor="#FFFFFF">微博超过一小时没更新，最近更新时间为:{{ interaction.publish_time | uniform_time }}</td>
                </tr>
                {% endfor %}
            </table>
        </div>
    ...
    <div id="dashboard-right" style="margin-top:37px;" class="span4">
        ...
        <div class="widgetcontent nopadding">
            <table width="100%" style="text-align:center;;font-size:14px;line-height:30px;" border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" >{{ violation.province_name }}</td>
                    <td bgcolor="#FFFFFF">{{ violation.province }}</td>
                    <td bgcolor="#FFFFFF">
                        {% if violation.max_time is empty %}

                        {% else %}
                            {{ violation.max_time | uniform_time }}
                        {% endif %}
                    </td>
                </tr>
                {% endfor %}
